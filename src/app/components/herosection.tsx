          ...
          <div className="text-center text-white px-4 animate-fade-in">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 max-w-6xl mx-auto border border-white/20 shadow-2xl transform hover:scale-105 transition-all duration-500">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="relative group">
                  <Calendar className="absolute left-4 top-1/2 transform -translate-y-1/2 text-accent-400 w-5 h-5 transition-all duration-300 group-hover:text-purple-300 group-hover:scale-110" />
                  <input
                    type="date"
                    className="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all duration-300 group-hover:bg-white/20 focus:scale-105"
                ...
                <div className="relative group">
                  ...
                  <input
                    type="date"
                    className="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-accennt-400 focus:border-transparent transition-all duration-300 group-hover:bg-white/20 focus:scale-105"
                ...
                <div className="relative group">
                  <Users className="absolute left-4 top-1/2 transform -translate-y-1/2 text-accent-400 w-5 h-5 transition-all duration-300 group-hover:text-purple-300 group-hover:scale-110" />
                  <select
                  ...
                  <ChevronDown className="absolute right-4 top-1/2 transform -translate-y-1/2 text-purple-400 w-5 h-5 pointer-events-none transition-all duration-300 group-hover:text-purple-300" />
                </div>
              </div>
